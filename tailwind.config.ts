  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        destructive: { DEFAULT: "hsl(var(--destructive))", foreground: "hsl(var(--destructive-foreground))", ink: "hsl(var(--destructive-ink))", subtle: "hsl(var(--destructive-subtle))", edge: "hsl(var(--destructive-edge))" },
        healthy: { DEFAULT: "hsl(var(--healthy))", foreground: "hsl(var(--healthy-foreground))", ink: "hsl(var(--healthy-ink))", subtle: "hsl(var(--healthy-subtle))", edge: "hsl(var(--healthy-edge))" },
        warning: { DEFAULT: "hsl(var(--warning))", foreground: "hsl(var(--warning-foreground))", ink: "hsl(var(--warning-ink))", subtle: "hsl(var(--warning-subtle))", edge: "hsl(var(--warning-edge))" },
        info: { DEFAULT: "hsl(var(--info))", foreground: "hsl(var(--info-foreground))", ink: "hsl(var(--info-ink))", subtle: "hsl(var(--info-subtle))", edge: "hsl(var(--info-edge))" },
