...
import { CaretRight, Check, Circle } from "@/components/icons";
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-[hsl(var(--accent-hover))] data-[state=open]:bg-[hsl(var(--accent-hover))] data-[state=open]:text-foreground",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-[200] min-w-[8rem] overflow-hidden rounded-[--radius] bg-popover border border-border-strong p-2 text-popover-foreground shadow-lg",
